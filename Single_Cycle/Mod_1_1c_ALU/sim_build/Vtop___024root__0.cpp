...
void Vtop___024root___ico_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    vlSelfRef.alu__DOT__alu_result = ((vlSelfRef.alu__DOT__operand1 
                                       + vlSelfRef.alu__DOT__operand2) 
                                      & (- (IData)(
                                                   (0U 
...
void Vtop___024root___eval(Vtop___024root* vlSelf) {
    ...
    do {
        if (VL_UNLIKELY(((0x00002710U < __VicoIterCount)))) {
            ...
            Vtop___024root___dump_triggers__ico(vlSelfRef.__VicoTriggered, "ico"s);
#endif
            VL_FATAL_MT("/Users/sarathivelmurugan/Desktop/RISCV_CPU/Single_Cycle/Mod_1_1c_ALU/alu.sv", 1, "", "DIDNOTCONVERGE: Input combinational region did not converge after '--converge-limit' of 10000 tries");
        }
