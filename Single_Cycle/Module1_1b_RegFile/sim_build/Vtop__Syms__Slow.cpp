    ...
    , TOP{this, namep}
{
    ...
    __Vscopep_TOP->varInsert("rs3", &(TOP.rs3), false, VLVT_UINT8, VLVD_IN|VLVF_PUB_RW, 0, 1 ,4,0);
    ...
    __Vscopep_regfile->varInsert("rs1", &(TOP.regfile__DOT__rs1), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,4,0);
    __Vscopep_regfile->varInsert("rs2", &(TOP.regfile__DOT__rs2), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,4,0);
    __Vscopep_regfile->varInsert("rs3", &(TOP.regfile__DOT__rs3), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,4,0);
